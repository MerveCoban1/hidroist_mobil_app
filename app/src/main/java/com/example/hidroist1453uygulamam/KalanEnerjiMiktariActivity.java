...
public class KalanEnerjiMiktariActivity extends AppCompatActivity {
    ListView listeKalanEnerjiMiktari;
    List<type1Pojo> list;
    type1Adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kalan_enerji_miktari);
        tanimla();
        istekAt();
    }

    public void tanimla() {
        listeKalanEnerjiMiktari = (ListView) findViewById(R.id.listeKalanEnerjiMiktari);
    }

    public void istekAt() {
        list = new ArrayList<>();
        Call<List<type1Pojo>> val = ManagerAll.getInstance().gosterKalanEnerjiMiktari();
        val.enqueue(new Callback<List<type1Pojo>>() {
            ...
            public void onResponse(Call<List<type1Pojo>> call, Response<List<type1Pojo>> response) {
                ...
                listeKalanEnerjiMiktari.setAdapter(adapter);
            }
