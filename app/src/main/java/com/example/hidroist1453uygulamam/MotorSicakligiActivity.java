...
public class MotorSicakligiActivity extends AppCompatActivity {
    ListView listeMotorSicakligi;
    List<type2Pojo> list;
    type2Adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_motor_sicakligi);
        tanimla();
        istekAt();
    }

    public void tanimla() {
        listeMotorSicakligi = (ListView) findViewById(R.id.listeMotorSicakligi);
    }

    public void istekAt() {
        list = new ArrayList<>();
        Call<List<type2Pojo>> val = ManagerAll.getInstance().gosterMotorSicaklik();
        val.enqueue(new Callback<List<type2Pojo>>() {
            ...
            public void onResponse(Call<List<type2Pojo>> call, Response<List<type2Pojo>> response) {
                ...
                listeMotorSicakligi.setAdapter(adapter);
            }
