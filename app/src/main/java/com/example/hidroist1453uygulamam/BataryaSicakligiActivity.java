...
public class BataryaSicakligiActivity extends AppCompatActivity {
    ListView listeBataryaSicakligi;
    List<type1Pojo> list;
    type1Adapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_batarya_sicakligi);
        tanimla();
        istekAt();
    }

    public void tanimla() {
        listeBataryaSicakligi = (ListView) findViewById(R.id.listeBataryaSicakligi);
    }

    public void istekAt() {
        list = new ArrayList<>();
        Call<List<type1Pojo>> val = ManagerAll.getInstance().gosterBataryaSicaklik();
        val.enqueue(new Callback<List<type1Pojo>>() {
            ...
            public void onResponse(Call<List<type1Pojo>> call, Response<List<type1Pojo>> response) {
                ...
                listeBataryaSicakligi.setAdapter(adapter);
            }
